...
{\begin{claim}\global\expandafter\edef\csname clm##1\endcsname{\thesubsection
...
{\begin{lemma}\global\expandafter\edef\csname lem##1\endcsname{\thesubsection
\noexpand\xspace}}{\end{lemma}}
\newenvironment{paperremark}[1]
{\begin{remark}\global\expandafter\edef\csname rem##1\endcsname{\thesubsection
\noexpand\xspace}}{\end{remark}}
\newenvironment{papertheorem}[1]
{\begin{theorem}\global\expandafter\edef\csname thm##1\endcsname{\thesubsection
\noexpand\xspace}}{\end{theorem}}
\newenvironment{paperquestion}[1]
{\begin{question}\global\expandafter\edef\csname qtn##1\endcsname{\thesubsection
...
\newenvironment{paperclaim}[1]
{\begin{claim}\global\expandafter\edef\csname clm##1\endcsname{\thesubsubsection
\noexpand\xspace}}{\end{claim}}
\newenvironment{paperconjecture}[1]
{\begin{conjecture}\global\expandafter\edef\csname cnj##1\endcsname{
\thesubsubsection\noexpand\xspace}}{\end{conjecture}}
...
\thesubsubsection\noexpand\xspace}}{\end{corollary}}
\newenvironment{paperlemma}[1]
{\begin{lemma}\global\expandafter\edef\csname lem##1\endcsname{\thesubsubsection
\noexpand\xspace}}{\end{lemma}}
\newenvironment{paperremark}[1]
