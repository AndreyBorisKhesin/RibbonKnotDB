...
ribbon knot by \defRibbon (see \figSingularities).
...
connects the discs, thereby replacing a single strand with a pair.
Since the only singularities in ribbon presentations can arise where the ribbons
go through the components, any ribbon presentation is a presentation of a ribbon
knot, making the name appropriate.}
